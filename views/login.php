...
if(isset($_POST['login'])){
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($contraseña, $row['user_pass'])) {
            $_SESSION['username'] = $row['user_login'];
            //echo "Login exitoso. Bienvenid@ ".$_SESSION['username'];
...
.dropdown-item:hover {
 ...
 <!-- Encabezado con menú desplegable -->
  ...
  <div class="container text-center">
    ...
    <h3>Ingresar</h3>
    <br>
    <h6>Si tenés usuario registrado en nuestra plataforma ingresalo acá</h6>
     <form method="post" action="">
        <input type="email" class="form-control-sm rounded-3 mb-2" name="email" value="" placeholder="Email" required autocomplete="off"><br>
        <input type="password" class="form-control-sm rounded-3 mb-2" name="contraseña" value="" placeholder="Contraseña" required autocomplete="off"><br><br>
        <button class="btn btn-secondary btn-lg" name="login" value="Login">Ingresar</button>
     </form>
