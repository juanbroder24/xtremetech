...
<body>
    ...
    <div class="container text-center">
        <br>
        <h1 class="fw-bold text-danger">Bares</h1>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<button type='submit' name='accion' value='ver_comentarios_bares' class='btn btn-danger mx-2'>Ver Comentarios</button>";
        echo "<input type='hidden' name='Nombre' value='" . $row["Nombre"] . "'>";
        echo "<button type='submit' name='accion' value='dejar_comentarios_bares' class='btn btn-danger mx-2'>Dejar Comentarios</button>";
        echo "</form>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
